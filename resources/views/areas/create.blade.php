...
@section('title', 'Crear Nueva Área Protegida')

@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">
                <i class="fas fa-plus-circle mr-2"></i> Crear Nueva Área Protegida
            </h3>
                            ...
                            <form action="{{ route('areas.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="descripcion" id="descripcion" class="form-control @error('descripcion') is-invalid @enderror"
                                        style="height: 150px;" placeholder="Escribe una descripción del área protegida...">{{ old('descripcion') }}
                                </textarea>
                                ...
                                <div class="d-flex justify-content-start mt-4">
                                    <button type="submit" class="btn btn-primary btn-action-custom">
                                        <i class="fas fa-save"></i> Guardar Área Protegida
                                    </button>
